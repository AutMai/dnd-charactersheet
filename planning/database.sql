...
-- -----------------------------------------------------
-- Table `dnd`.`CLASS_has_FEATURES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_FEATURES` (
  `CLASS_ID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_WEAPON_PROFICIENCIES` (
  ...
  INDEX `fk_CLASSES_has_E_WEAPON_TYPES_E_WEAPON_TYPES1_idx` (`WEAPON_TYPE` ASC) VISIBLE,
  INDEX `fk_CLASSES_has_E_WEAPON_TYPES_CLASSES1_idx` (`CLASS_ID` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `dnd`.`CLASS_has_ABILITY_PROFICIENCIES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_ABILITY_PROFICIENCIES` (
  `CLASS_ID` INT NOT NULL,
  `ABILITY_NAME` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`CLASS_ID`, `ABILITY_NAME`),
  INDEX `fk_CLASSES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1_idx` (`ABILITY_NAME` ASC) VISIBLE,
  INDEX `fk_CLASSES_has_E_ABILITY_NAMES_CLASSES1_idx` (`CLASS_ID` ASC) VISIBLE,
  CONSTRAINT `fk_CLASSES_has_E_ABILITY_NAMES_CLASSES1`
    FOREIGN KEY (`CLASS_ID`)
    REFERENCES `dnd`.`CLASSES` (`CLASS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CLASSES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1`
...
-- -----------------------------------------------------
-- Table `dnd`.`CLASS_has_SKILL_PROFICIENCIES_CHOICES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_SKILL_PROFICIENCIES_CHOICES` (
  `CLASS_ID` INT NOT NULL,
  `SKILL_NAME` VARCHAR(45) NOT NULL,
  `AMOUNT` INT NOT NULL,
  PRIMARY KEY (`CLASS_ID`, `SKILL_NAME`),
  INDEX `fk_CLASSES_has_E_SKILL_NAMES_E_SKILL_NAMES1_idx` (`SKILL_NAME` ASC) VISIBLE,
  INDEX `fk_CLASSES_has_E_SKILL_NAMES_CLASSES1_idx` (`CLASS_ID` ASC) VISIBLE,
  CONSTRAINT `fk_CLASSES_has_E_SKILL_NAMES_CLASSES1`
    FOREIGN KEY (`CLASS_ID`)
    REFERENCES `dnd`.`CLASSES` (`CLASS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CLASSES_has_E_SKILL_NAMES_E_SKILL_NAMES1`
...
-- -----------------------------------------------------
-- Table `dnd`.`RACE_has_ABILITY_SCORE_INCREASES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dnd`.`RACE_has_ABILITY_SCORE_INCREASES` (
  `RACE_ID` INT NOT NULL,
  `ABILITY_NAME` VARCHAR(45) NOT NULL,
  `INCREASE` INT NOT NULL,
  PRIMARY KEY (`RACE_ID`, `ABILITY_NAME`, `INCREASE`),
  INDEX `fk_RACES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1_idx` (`ABILITY_NAME` ASC) VISIBLE,
  INDEX `fk_RACES_has_E_ABILITY_NAMES_RACES1_idx` (`RACE_ID` ASC) VISIBLE,
  CONSTRAINT `fk_RACES_has_E_ABILITY_NAMES_RACES1`
    FOREIGN KEY (`RACE_ID`)
    REFERENCES `dnd`.`RACES` (`RACE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_RACES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1`
    FOREIGN KEY (`ABILITY_NAME`)
    REFERENCES `dnd`.`E_ABILITY_NAMES` (`NAME`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
