...
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_ABILITY_PROFICIENCIES` (
  `CLASSES_CLASS_ID` INT NOT NULL,
  `E_ABILITY_NAMES_NAME` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`CLASSES_CLASS_ID`, `E_ABILITY_NAMES_NAME`),
  INDEX `fk_CLASSES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1_idx` (`E_ABILITY_NAMES_NAME` ASC) VISIBLE,
  INDEX `fk_CLASSES_has_E_ABILITY_NAMES_CLASSES1_idx` (`CLASSES_CLASS_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_CLASSES_has_E_ABILITY_NAMES_E_ABILITY_NAMES1`
    FOREIGN KEY (`E_ABILITY_NAMES_NAME`)
    REFERENCES `dnd`.`E_ABILITY_NAMES` (`NAME`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dnd`.`CLASS_has_SKILL_PROFICIENCIES_CHOICES` (
  ...
  INDEX `fk_CLASSES_has_E_SKILL_NAMES_E_SKILL_NAMES1_idx` (`SKILL` ASC) VISIBLE,
